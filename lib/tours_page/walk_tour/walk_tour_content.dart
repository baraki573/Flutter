...
class TourWalkerContent extends StatefulWidget {
  ...
  TourWalkerContent(this.stop, {Key key, this.color=Colors.pink, this.showTasks=true}) : super(key: key);
...
class _TourWalkerContentState extends State<TourWalkerContent> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        // Images
        feat.showImages ? _imageView() : Container(),
...
Widget _information(showText, showDetails) {
  return Container(
    ...
    child: Column(
      ...
      children: [
        showText ? _text() : Container(),
        showDetails ? _informationTable(widget.stop.stop) : Container(),
        widget.showTasks ? TourWalkerTasks(widget.stop.tasks) : Container(),
      ],
    ),
  );
}
